...
class MDTopology(Topology):
    ...
    @classmethod
    def mdanalysis_to_mdtraj(mda_topol, standard_replacements=True,
                             martini=False):
        """
        ...
        standard_replacements - bool, wheter to try to replace
                                known residue and atom names,
                                default is True
        martini - bool, wheter the MDAnalysis.Topology is a
        ...
        # loop structure orientend @ how mdtraj builds its topology from pdb-files
